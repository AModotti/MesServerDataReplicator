...
public class F0101F {
	...
	public void executeImport(Connection connA,Connection connB) {
        ...
        LogWriter.write("Importazione dati su tabella di frontiera: F0101F - [ Rubrica Indirizzi ]");
        
		System.out.println("");
        System.out.println("Importazione dati su tabella di frontiera: F0101F - [ Rubrica Indirizzi ]");
        
        try {
			stmB = connB.prepareStatement("DELETE FROM MES.F0101F");
			stmB.execute();
			
			LogWriter.write("Pulitura tabella: .................................................................................................... [ OK ]");	        						
			System.out.println("Pulitura tabella: .................................................................................................... [ OK ]");
	        
	        stmA = connA.prepareStatement("SELECT COUNT(*) FROM F0101 WHERE ABAT1 IN ('E','WC','C','CS')");
			...
			stmA = connA.prepareStatement("SELECT * FROM F0101 WHERE ABAT1 IN ('E','WC','C','CS')");
			stmB = connB.prepareStatement("INSERT INTO F0101F VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			rs = stmA.executeQuery();
